...
import os
from functions.common.createContainer import get_blob_client_by_name
from functions.manageBlobsInContainer import upload_blob, download_blob, list_blobs
...
if __name__ == "__main__":
    ...
    if blob_client:
        ...
        # upload_blob(blob_name, local_file_path_to_upload, blob_client)
